...
df_raw_train = pd.read_csv("HW1_dataset//train-100-100.csv")

#import csv file for test-100-10
df_raw_test = pd.read_csv("HW1_dataset//test-100-100.csv")
...
#    mse_graph.to_csv("mse_test_100_100.csv", index = False)
...
plt.xlabel("Lambda")
plt.ylabel("MSE")
plt.title("MSE graph for train-100-100 and test-100-100")
